...
from util import _read_json, get_dict_by_conf, get_report_icx_TOR_dump, get_report_cpx_TOR_dump, \
    cpx_reg_mapping, icx_reg_mapping, merge_dic, get_file_retxt, deal_bankid_None, write_log, generate_file
...
#         @param - component_info: the function get_component_info()'s return value. return - all_log_list, error_list:
...
def deal_report(report_filename, component_info):
    ...
    try:
        ...
        for log in json_object:
            ...
            crashdump_all['METADATA'] = get_dict_by_conf("crashdump_all", txt)
            ...
            if crashdump_all['PROCESSORS']:
                ...
                print(crashdump_all)
                generate_file(report_filename, crashdump_all, int(crashdump_all['METADATA']['LogIndex']))
